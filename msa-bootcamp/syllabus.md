...
**IMPORTANT**: Include [MSA Bootcamp Student] in the subject of course-related email, e.g., "Subject: [MSA Bootcamp Student] functools Question." Professors are deluged with email. If we don't respond, don't take it personally. Just resend your email with a friendly reminder.
