...
For each expression below, write the value and then the Python data type of the evaluated legal expression in the space provided.  \\\\
...
\ifprintanswers
\hspace{-.5in} Expression: {\tt 1 if 2 else 3}
\part[2] Calculated value: \underline{ {\tt 1 } }
\part[1] Type: \underline{ {\tt int}  }\\
\else
\hspace{-.5in} Expression: {\tt 1 if 2 else 3}
\part[2] Calculated value: \makebox[1in]{\hrulefill}
\part[1] Type: \makebox[1in]{\hrulefill}\\
\fi
...
\part[4] What is the value of {\tt list(enumerate(['today', 'is', 'a', 'great', 'day']))}?

\begin{choices}
\choice {\tt [('today', 1), ('is', 2), ('a', 3), ('great', 4), ('day', 5)]}
\choice {\tt [‘todayisagreatday’]}
\correctchoice {\tt [(0, 'today'), (1, 'is'), (2, 'a'), (3, 'great'), (4, 'day')]}
\correctchoice the location of an iterable object
\end{choices}
